...
const SummarizeBlogPostOutputSchema = z.object({
  ...
  progress: z.string().describe('Progress of the blog summarization process.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert blog post summarizer.  You will be given the content of a blog post, and you will write a short summary of the blog post.
...
const summarizeBlogPostFlow = ai.defineFlow(
  ...
  async input => {
    ...
    output!.progress = 'Generated a one-sentence summary of the blog post content.';
    return output!;
  }
);
